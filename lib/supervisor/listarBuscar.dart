...
class ListarSupervisor extends StatelessWidget {
  const ListarSupervisor({
    Key? key,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Procurar cadastro de um supervisor"),
        centerTitle: true,
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: TextButton(
                ...
                onPressed: () {
                  //navega para a rota '/dashboard' quando o botão é clicado
                  Navigator.of(context).pushReplacementNamed('/atualizarSupervisor');
                },
              ),
            ),
            SizedBox(
            ...
            Container(
              ...
              child: TextButton(
                ...
                onPressed: () {
                  //navega para a rota '/dashboard' quando o botão é clicado
                  Navigator.of(context).pushReplacementNamed('/deletarSupervisor');
                },
              ),
            ),
          ],
