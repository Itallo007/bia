...
class ListarVaga extends StatelessWidget {
  const ListarVaga({
    Key? key,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Procurar cadastro de uma vaga"),
        centerTitle: true,
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: TextButton(
                ...
                onPressed: () {
                  //navega para a rota '/dashboard' quando o botão é clicado
                  Navigator.of(context).pushReplacementNamed('/atualizarVaga');
                },
              ),
            ),
            SizedBox(
            ...
            Container(
              ...
              child: TextButton(
                ...
                onPressed: () {
                  //navega para a rota '/dashboard' quando o botão é clicado
                  Navigator.of(context).pushReplacementNamed('/deletarVaga');
                },
              ),
            ),
          ],
