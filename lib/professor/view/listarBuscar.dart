...
class ListarProfessor extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Procurar cadastro de um professor"),
        centerTitle: true,
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: TextButton(
                ...
                onPressed: () {
                  //navega para a rota '/dashboard' quando o botão é clicado
                  Navigator.of(context).pushReplacementNamed('/atualizarProfessor');
                },
              ),
            ),
            SizedBox(
            ...
            Container(
              ...
              child: TextButton(
                ...
                onPressed: () {
                  //navega para a rota '/dashboard' quando o botão é clicado
                  Navigator.of(context).pushReplacementNamed('/deletarProfessor');
                },
              ),
            ),
          ],
