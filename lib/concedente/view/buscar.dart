...
class BuscarConcedente extends StatelessWidget {
  const BuscarConcedente({
    Key? key,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Buscar dados de uma concedente"),
        centerTitle: true,
            ...
            Container(
              ...
              child: TextButton(
                ...
                onPressed: () {
                  ...
                  Navigator.of(context).pushReplacementNamed('/listarBuscarConcedente');
                },
              ),
            ),
          ],
